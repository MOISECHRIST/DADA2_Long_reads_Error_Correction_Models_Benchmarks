...
#SOURCE : https://github.com/benjjneb/dada2/issues/938
loessErrfun_mod0 <- function (trans) {
...
#Alters the weights and span in loess, also enforce monotonicity
...
#Source : https://github.com/benjjneb/dada2/issues/1307#issuecomment-957680971
#Only alter loess weights and also enforce monotonicity
...
#Source : https://github.com/benjjneb/dada2/issues/1307#issuecomment-957680971
#Alter loess function arguments (weights, span, and degree) also enforce monotonicity.
